...
class Settings:
    host: str = os.getenv("AUTOBOT_HOST", "10.8.0.1")
    port: int = int(os.getenv("AUTOBOT_PORT", "8161"))
    ...
    owner_id: int = int(os.getenv("OWNER_ID", "484184861"))
    db_file: str = os.getenv("DB_FILE", "/opt/data/autobot/autobot.db")
